...
public class CompilationUnitVisitor extends ASTVisitor {
   ...
   * variable, a {@link VariableBindingManager} is created and stored in listVariables map.
   * 
   * @param node
   *          the node to visit
   ...
   * If the binding is found in the listVariables map, we have an
   ...
   * name and looks for it in the listVariables map.
