...
public abstract class Constant {
	...
	public abstract class File {
		...
		public static final String	FILE_ENTRY_POINT							= Folder.ENTRY_POINT
																						+ "entry_point.xml";
		public static final String	FILE_RESOLUTION								= Folder.RESOLUTION + "resolution.xml";

		public static final String	FILE_EXIT_POINT_COMMAND_INJECTION			= Folder.EXIT_POINT
																						+ "command_injection.xml";
		public static final String	FILE_EXIT_POINT_COOKIE_POISONING			= Folder.EXIT_POINT
																						+ "cookie_poisoning.xml";
		...
		public static final String	FILE_EXIT_POINT_LDAP_INJECTION				= Folder.EXIT_POINT
																						+ "ldap_injection.xml";

		public static final String	FILE_EXIT_POINT_LOG_FORGING					= Folder.EXIT_POINT + "log_forging.xml";

		public static final String	FILE_EXIT_POINT_PATH_TRAVERSAL				= Folder.EXIT_POINT
																						+ "path_traversal.xml";
		...
		public static final String	FILE_EXIT_POINT_SQL_INJECTION				= Folder.EXIT_POINT
																						+ "sql_injection.xml";

		public static final String	FILE_EXIT_POINT_XPATH_INJECTION				= Folder.EXIT_POINT
																						+ "xpath_injection.xml";
	}
