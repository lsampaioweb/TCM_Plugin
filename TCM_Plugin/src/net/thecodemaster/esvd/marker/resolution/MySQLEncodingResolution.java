...
public class MySQLEncodingResolution extends AbstractEncodingResolution {

	private static final String	ESAPI_IMPORT						= "org.owasp.esapi.ESAPI";
	private static final String	MYSQL_CODEC_IMPORT			= "org.owasp.esapi.codecs.MySQLCodec";
	private static final String	MYSQL_CODEC_MODE_IMPORT	= "org.owasp.esapi.codecs.MySQLCodec.Mode";
	private static final String	MYSQL_CODEC_INSTANCE		= "new MySQLCodec(Mode.STANDARD)";
	...
	public void run(IMarker marker) {
		try {
			...
			listImport.add(MYSQL_CODEC_IMPORT);
			listImport.add(MYSQL_CODEC_MODE_IMPORT);
	...
	protected void generateEncoding(CompilationUnit cUnit, IDocument document, int offset, int length)
		...
		args.add(0, (Expression) astRewrite.createStringPlaceholder(MYSQL_CODEC_INSTANCE, ASTNode.CLASS_INSTANCE_CREATION));
