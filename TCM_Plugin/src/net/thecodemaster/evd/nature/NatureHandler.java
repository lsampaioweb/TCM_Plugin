package net.thecodemaster.evd.nature;
...
public class NatureHandler {
   ...
   * 
   * @param project The project to have the nature added.
   * @throws CoreException
   */
   ...
   * 
   * @param projects Collection of projects to have the nature removed.
   * @throws CoreException
   */
   ...
   * 
   * @param project The project to have the nature removed.
   * @throws CoreException
   */
