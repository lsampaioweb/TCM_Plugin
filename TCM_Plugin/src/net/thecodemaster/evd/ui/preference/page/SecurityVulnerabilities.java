...
public class SecurityVulnerabilities extends AbstracPreferencePage {
	...
	private void createSecurityVulnerabilityOptions(Composite composite) {
		...
		groupSecurityVulnerabilities.setText(Messages.PrefPageSecurityVulnerabilities.LABEL_SECURITY_VULNERABILITIES);
		...
		ckbtnCookiePoisoning = createBooleanField(Constant.PrefPageSecurityVulnerability.FIELD_COOKIE_POISONING,
				Messages.PrefPageSecurityVulnerabilities.LABEL_COOKIE_POISONING, groupSecurityVulnerabilities);
		ckbtnCrossSiteScripting = createBooleanField(Constant.PrefPageSecurityVulnerability.FIELD_CROSS_SITE_SCRIPTING,
				Messages.PrefPageSecurityVulnerabilities.LABEL_CROSS_SITE_SCRIPTING, groupSecurityVulnerabilities);
		ckbtnSecurityMisconfiguration = createBooleanField(
				Constant.PrefPageSecurityVulnerability.FIELD_SECURITY_MISCONFIGURATION,
				Messages.PrefPageSecurityVulnerabilities.LABEL_SECURITY_MISCONFIGURATION, groupSecurityVulnerabilities);
		ckbtnSQLInjection = createBooleanField(Constant.PrefPageSecurityVulnerability.FIELD_SQL_INJECTION,
				Messages.PrefPageSecurityVulnerabilities.LABEL_SQL_INJECTION, groupSecurityVulnerabilities);
	}

	private void createMonitoredProjectsSelection(Composite composite) {
		Label label = new Label(composite, SWT.NONE);
		label.setText(Messages.PrefPageSecurityVulnerabilities.LABEL_MONITORED_PROJECTS);
